...
CREATE TABLE dashboard_district_noise_summary (
                                                ...
                                                PRIMARY KEY (batch_id, autonomous_district)
);
...
CREATE TABLE dashboard_district_noise_hourly (
                                               ...
                                               PRIMARY KEY (batch_id, autonomous_district, hour)
);
...
CREATE TABLE dashboard_district_noise_yearly (
                                               ...
                                               avg_noise NUMERIC(5, 2) NULL,
                                               PRIMARY KEY (batch_id, region_type, region_name, year)
);
...
CREATE TABLE dashboard_district_noise_zone (
                                             ...
                                             end_date DATE NULL,
                                             avg_noise NUMERIC(5, 2) NULL,
                                             PRIMARY KEY (batch_id, autonomous_district, administrative_district)
);
